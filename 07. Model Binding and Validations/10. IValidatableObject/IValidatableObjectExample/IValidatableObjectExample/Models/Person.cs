...
using IValidatableObjectExample.CustomValidators;
...
namespace IValidatableObjectExample.Models
{
    ...
    {
        //Requirement -> either of date of birth or age should be submitted, either date of birth can be null or age can be null
        //not both at a time this is your validation requirement if both are null return error message
