using ModelValidatorMultiplePropEg.CustomValidators;
using System.ComponentModel.DataAnnotations;

namespace ModelValidatorMultiplePropEg.Models
{
    public class Person
    {
        ...
        //2nd
        //in below we are comparing ToDate with FromDate
        [DateRangeValidator("FromDate", ErrorMessage = "'FromDate' should be " +
            "older than or equal to 'ToDate'")]
